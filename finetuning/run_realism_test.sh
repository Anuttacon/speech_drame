...
# Configuration
MODEL_PATH="exp/sft_lora_all-real-v2/checkpoint-10000"  # Path to your trained model
DATA_FILE="data/test_all/data.jsonl"  # Test data file
OUTPUT_DIR="results/sft_lora_all-real-v2_specific_dimension_checkpoint-10000_testall"
# MODEL_PATH="exp/sft_finetune_base_all-real-v2/checkpoint-3000"  # Path to your trained model
# DATA_FILE="data/test_all/data.jsonl"  # Test data file
# OUTPUT_DIR="results/sft_finetune_base_all-real-v2_checkpoint-3000"
...
DIMENSIONS=("pitch_dynamics" "rhythmic_naturalness" "stress_emphasis" "emotion_accuracy" "emotion_intensity" "emotional_dynamic_range" "voice_identity_matching" "trait_embodiment" "local_scene_fit" "global_story_fit")
# DIMENSIONS=("global_story_fit" "local_scene_fit" "trait_embodiment" "voice_identity_matching" "emotional_dynamic_range" "emotion_intensity" "emotion_accuracy" "stress_emphasis" "rhythmic_naturalness" "pitch_dynamics")
# DIMENSIONS=("trait_embodiment" "voice_identity_matching" "emotional_dynamic_range" "emotion_intensity" "emotion_accuracy")
...
for dimension in "${DIMENSIONS[@]}"; do
    ...
    OUTPUT_FILE="${OUTPUT_DIR}/role_eval_${dimension}_exact.json"
