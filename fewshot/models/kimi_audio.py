...
class KimiAudio(BaseAudioLLM):
    def __init__(self, model_name: str, model_tag: str, system_prompt: str, temperature: float = 1.5):
        ...
        # Find token IDs for numbers 1-5
    ...
    def _get_score_from_token_probabilities(self, audio_input_ids: torch.Tensor, text_input_ids: torch.Tensor, 
                                          is_continuous_mask: torch.Tensor, continous_feature: List[torch.Tensor]) -> float:
        """
        ...
        try:
            ...
            return self._fallback_generate_score(audio_input_ids, text_input_ids, is_continuous_mask, continous_feature)
        ...
        while True:
            try:
                ...
                response = self._get_score_from_token_probabilities(
                    audio_input_ids, text_input_ids, is_continuous_mask, audio_features
                )
    ...
    def evaluate_with_schema(self, audio_path: str, prompt: str) -> Dict[str, Any]:
