...
def extract_scores_from_response(response: str) -> Dict[str, int]:
    ...
    try:
        ...
        scores = {}
        dimensions = [
            'audio_quality', 'human_likeness', 'appropriateness'
        ]
        ...
        return {
            'audio_quality': 1, 'human_likeness': 1, 'appropriateness': 1,
        }
...
def extract_ground_truth_scores(annotation_data: Dict[str, Any]) -> Dict[str, List[int]]:
    ...
    source_dimensions = ["audio_quality", "human_likeness", "appropriateness"]
...
def extract_ground_truth_scores_raw(annotation_data: Dict[str, Any]) -> Dict[str, List[int]]:
    ...
    for i in range(3):
        ...
        scores['audio_quality'].append(safe_int_convert(annotation_data[f"{prefix}audio_quality"]))
        scores['human_likeness'].append(safe_int_convert(annotation_data[f"{prefix}human_likeness"]))
        scores['appropriateness'].append(safe_int_convert(annotation_data[f"{prefix}appropriateness"]))
